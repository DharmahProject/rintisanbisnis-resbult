<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    <defs>
        ...
        <symbol xmlns="http://www.w3.org/2000/svg" id="medal" viewBox="0 0 24 24">
            <path fill="none" stroke="currentColor" d="M14 8.667a2 2 0 1 1-2-2 2 2 0 0 1 2 2zm8.756 7.679a1 1 0 0 1-.632 1.646l-3.672.46-.46 3.672a1 1 0 0 1-1.792.476L12 17l-4.2 5.6a1 1 0 0 1-1.792-.476l-.46-3.672-3.672-.46a1 1 0 0 1-.632-1.646l3.826-4.422a7.667 7.667 0 1 1 13.86 0zm-12.587-.238c-.021 0-.041-.015-.062-.021a7.684 7.684 0 0 1-3.884-2.4c-.006-.007-.014-.012-.02-.02L3.98 16.24l2.588.323a1 1 0 0 1 .869.869l.248 1.988zm7.5-7.441A5.667 5.667 0 1 0 12 14.333a5.673 5.673 0 0 0 5.667-5.666zm2.351 7.573-2.22-2.569a7.72 7.72 0 0 1-3.9 2.416c-.021.006-.041.016-.062.021l2.484 3.312.248-1.988a1 1 0 0 1 .869-.869z" />
        </symbol>
        <symbol xmlns="http://www.w3.org/2000/svg" id="home" viewBox="0 0 24 24">
            <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M3 12l9-9l9 9M9 21V12h6v9" />
        </symbol>
        <symbol id="warranty" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 22c-3.87-1.47-8-5.13-8-10V5l8-3 8 3v7c0 4.87-4.13 8.53-8 10z"></path>
        ...
        <div class="row py-3 border-bottom">
            ...
            <div class="col-sm-4 col-lg-2 text-center text-sm-start d-flex gap-3 justify-content-center justify-content-md-start">
                <div class="d-flex align-items-center my-3 my-sm-0">
                    <a href="index.html">
                        <img src="{{ url('assets/img/logo.jpg') }}" alt="logo" class="img-fluid">
                    </a>
                </div>
                  ...
                  <option>Chocolates</option>
                    ...
                    <div class="col-11 col-md-11">
                        <form id="search-form" class="text-center" action="index.html" method="post">
                            <input type="text" class="form-control border-0 bg-transparent" placeholder="Pencarian">
                        </form>
                    </div>
                    <div class="col-1">
            ...
            <div class="col-lg-4">
                <ul class="navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark" style="    font-size: 14px;">
                    <li class="nav-item active">
                        <a href="{{ url('home') }}" class="nav-link">Home</a>
                    </li>
                    <li class="nav-item active">
                        <a href="{{ url('storedetail') }}" class="nav-link">Store</a>
                    </li>
                    <li class="nav-item active">
                    ...
                    <!-- <li class="nav-item">
                            <a href="index.html" class="nav-link">Lokasi</a>
                        </li>
                        <li class="nav-item">
                            <a href="index.html" class="nav-link">Status Transaksi</a>
                        </li> -->
                </ul>
            </div>
                ...
                <ul class="d-flex justify-content-end list-unstyled m-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="pages">
                            <li><a href="index.html" class="dropdown-item">Daftar</a></li>
                            <li><a href="index.html" class="dropdown-item">Login </a></li>
